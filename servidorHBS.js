...
const lista = require('./prodAleatorios.js');
const daoMensaje = require('./src/index.js').daoMensaje;
const daoUsuario = require('./src/index.js').daoUsuario;
const normalizado = require('./normalizado.js');
...
module.exports = arg
const apiRandom= require('./controllers/apiRandom.js') 
